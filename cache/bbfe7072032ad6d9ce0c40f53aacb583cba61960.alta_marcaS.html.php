...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.28',
  'unifunc' => 'content_575328a4690878_82105517',
  'file_dependency' => 
  array (
...
function content_575328a4690878_82105517 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <h1>Actualizar Categoria</h1>
                    <form role="form" action="../Admin/altaMarcaC.php" method="post" id="form" autocomplete="off">
                        <div class="form-group">
                            ...
                            <input type="text" name="categoria" class="form-control" placeholder="Nombre de la marca" value="pastel">
                            <input type="hidden" value="2" name="id_marca"></input>
                        </div>
